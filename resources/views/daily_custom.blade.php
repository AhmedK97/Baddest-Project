...
<div class="container" dir="rtl">
    <div x-data="{ open: false }">
        ...
        <div x-show="open" x-transition.duration.500ms>
            <form class="mb-2" action="daily_custom">
    ...
    <!--Start Container-->
    <h2 class="text-center mb-4"> <strong class="">جرد يوم {{ $time }}</strong></h2>
    @foreach ($operation as $op )
    @if($op->doctor->id < 5) @foreach ($op->transactions->where('created_at', '=', $time .' 00:00:00') as $o )
        @php
        $total[] = $o->payed;
        @endphp
        @endforeach
        ...
        <h5> <label><img src="/images/cash.svg" alt="clock"></label> اجمالى الجرد اليومي : <strong style="color: green">EGP
        ...
        <div class="d-flex flex-column">
            ...
            @foreach ($operation as $op )
            @if($op->doctor->id == 1)
            @foreach ($op->transactions->where('created_at', '=', $time .' 00:00:00') as $o )
            @php
            $x1[] = $o->payed;
