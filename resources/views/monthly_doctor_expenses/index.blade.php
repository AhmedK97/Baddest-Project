...
@if (isset($month))
<h2 class="text-center mb-4"> <strong class=""> مستهلك الدكاترة لشهر {{ $month }} لسنه {{$year}}</strong></h2>
...
<div class="position-relative" x-data="{ open: false }">
    ...
    <a style="    height: 40px;" class="btn btn-danger position-absolute top-0 start-0"" href=" /monthly_doctor_expenses_dele">المحذوف</a>
</div>
