...
<br>
<h2 class="text-center mb-4"> <strong class="">جرد حافظ المسافه لشهر {{ $month }} سنه {{ $year }} </strong></h2>
...
<div class="d-flex d-flex justify-content-between">
    ...
    @else
    <h5><label><img src="/images/cash.svg" alt="clock"></label> اجمالى حافظ المسافه : <strong style="color: rgb(0, 145, 0)">EGP
            {{$s}}</strong>
    </h5>
        ...
        <table class="table text-center">
            ...
            <tbody class=" bg-secondary text-white ">
                <tr>
                    ...
                    @if ( ($comment->comment == 10) && $comment->created_at->format('m') == $month )
                    <td> <span>
                        حافظ مسافه
                        </span>
                    </td>
